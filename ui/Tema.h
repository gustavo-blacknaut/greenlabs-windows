...
// O vermelho do botao de parar em repouso: mais escuro que o de realce, pelo
// mesmo motivo do verde - quem esta transmitindo nao precisa de um botao
// gritando na lateral o tempo todo.
inline constexpr D2D1_COLOR_F kVermelhoSuave = cor(0xB3413F);
